  ...
  deleteButton.onclick = function () {
    ...
    setTimeout(function () {
      window.location.replace(
        "https://imagin-expo-df9765.webflow.io/admin/admin-demandes"
      );
    }, 1000);
  };
}
  ...
  DetailDemandeUpdateButton.onclick = function () {
    ...
    if (
      ...
      mailJson = {
        ...mailJson,
        text:
          "Refus de votre demande de stand : https://imagin-expo-df9765.webflow.io/recapitulatif-demande-de-stand#" +
          data._id,
      };
    } else if (
      document.getElementById("inputRequestState").value === "20" &&
      ...
      mailJson = {
        ...mailJson,
        text:
          "Votre demande de stand à été confirmée : https://imagin-expo-df9765.webflow.io/recapitulatif-demande-de-stand#" +
          data._id,
      };
      ...
      mailJson = {
        ...mailJson,
        text:
          "Votre demande de stand à été clôturée : https://imagin-expo-df9765.webflow.io/recapitulatif-demande-de-stand#" +
          data._id,
      };
    } else {
      json = {
